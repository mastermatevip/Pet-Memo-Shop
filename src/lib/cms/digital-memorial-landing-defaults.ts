...
export function defaultDigitalMemorialLandingContent(): DigitalMemorialLandingContent {
  return {
    ...
    sampleLinks: {
      title: "Example Digital Memorial Pages",
      subtitle: "Preview real memorial pages — tap a card to open the online tribute.",
      linkLabel: "View memorial →",
      items: [
        {
          title: "BELLA",
          slug: "companion-1ae0d3",
          image: "",
          imageAlt: "BELLA digital pet memorial page",
        },
        {
          title: "COCO",
          slug: "companion",
          image: "",
          imageAlt: "COCO digital pet memorial page",
        },
        {
          title: "Milo",
          slug: "beloved-companion",
          image: "",
          imageAlt: "Milo digital pet memorial page",
        },
      ],
    },
    orderSteps: {
