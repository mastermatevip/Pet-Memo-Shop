...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-bg/95 backdrop-blur-sm border-b border-border">
        ...
        <div className="flex items-center justify-between h-[4.5rem] md:h-24 gap-4">
          ...
          <nav className="site-header-desktop-nav items-center gap-6 xl:gap-8">
            ...
            >
              <button
                type="button"
                className="flex items-center gap-1 text-muted hover:text-text transition-colors text-sm font-medium whitespace-nowrap"
              >
                {t("shop")}
          ...
          <div className="flex items-center gap-2 md:gap-3 shrink-0">
            ...
            <button
              type="button"
              aria-label={t("menu")}
              className="site-header-menu-btn p-2 text-muted hover:text-text shrink-0"
      ...
      <div
        className={cn(
          "site-header-mobile-panel overflow-hidden transition-all duration-300 bg-card border-t border-border",
          mobileOpen ? "is-open max-h-[80vh] overflow-y-auto" : "max-h-0"
        )}
      >
